...
df_ts_M101_n["timetravelledinhours"] = pd.to_timedelta(df_ts_M101_n["arrival_time"]).dt.total_seconds()/3600
df_ts_M101_n["timedifference"] = df_ts_M101_n["timetravelledinhours"].diff().abs()
