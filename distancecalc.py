...
MTA_Bus_Stops = pd.read_csv('insert path for GTFS MTA Bus Stop file')
...
#(insertions required)
df_ts_bl_0.to_csv("INSERTBUSLINENAME_DIRECTION_dist.csv", index=False)
df_ts_bl_1.to_csv("INSERTBUSLINENAME_DIRECTION_dist.csv", index=False)
